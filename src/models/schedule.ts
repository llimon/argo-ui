...
//import { WorkflowsList } from '../app/workflows/components/workflows-list/workflows-list';
import { NodeStatus } from './workflows';
import { Template } from './workflows';
import { Arguments } from './workflows';
...
//     /**
//      * Artifacts is the list of artifacts to pass to the template or schedule
//      */
//     artifacts?: Artifact[];
//     /**
//      * Parameters is the list of parameters to pass to the template or schedule
//      */
...
//  * It is also used to describe the location of multiple artifacts such as the archive location of a single schedule step,
...
// }
// /**
//  * RetryStrategy provides controls on how to retry a schedule step
//  */
...
// /**
//  * Template is a reusable and composable unit of execution in a schedule
//  */
...
//     /**
//      * Affinity sets the pod's scheduling constraints Overrides the affinity set at the schedule level (if any)
//      */
//     affinity?: kubernetes.Affinity;
//     /**
//      * Location in which all files related to the step will be stored (logs, artifacts, etc...).
//      * Can be overridden by individual items in Outputs.
//      * If omitted, will use the default artifact repository location configured in the controller, appended with the <schedulename>/<nodename> in the key.
//      */
...
//     /**
//      * Deamon will allow a schedule to proceed to the next step so long as the container reaches readiness
//      */
//     daemon?: boolean;
//     /**
...
//     name: string;
//     /**
//      * NodeSelector is a selector to schedule this step of the schedule to be run on the selected node(s). Overrides the selector set at the schedule level.
//      */
...
//     sidecars?: Sidecar[];
//     /**
//      * Steps define a series of sequential/parallel schedule steps
//      */
//     steps?: ScheduleStep[][];
...
/**
 * Schedule is the definition of a schedule resource
 */
...
export function compareSchedule(first: Schedule, second: Schedule) {
...
export interface ScheduleStatus {
    ...
    /**
     * Phase a simple, high-level summary of where the schedule is in its lifecycle.
     */
    phase: string;
    startedAt: kubernetes.Time;
    finishedAt: kubernetes.Time;
    /**
     * A human readable message indicating details about why the schedule is in this condition.
     */
    message: string;
    ...
    /**
     * PersistentVolumeClaims tracks all PVCs that were created as part of the schedule.
     * The contents of this list are drained at the end of the schedule.
     */
...
/**
 * ScheduleList is list of Schedule resources
 */
...
/**
 * ScheduleSpec is the specification of a Schedule.
 */
export interface ScheduleSpec {
    /**
     * Affinity sets the scheduling constraints for all pods in the schedule. Can be overridden by an affinity specified in the template
     */
    affinity?: kubernetes.Affinity;
    /**
     * Arguments contain the parameters and artifacts sent to the schedule entrypoint.
     * Parameters are referencable globally using the 'schedule' variable prefix. e.g. {{schedule.parameters.myparam}}
     */
    arguments?: Arguments;
    /**
     * Entrypoint is a template reference to the starting point of the schedule
     */
    entrypoint: string;
    /**
    ...
    /**
     * NodeSelector is a selector which will result in all pods of the schedule to be scheduled on the selected node(s).
     * This is able to be overridden by a nodeSelector specified in the template.
     */
    nodeSelector?: { [key: string]: string; };
    /**
     * OnExit is a template reference which is invoked at the end of the schedule, irrespective of the success, failure, or error of the primary schedule.
     */
    onExit?: string;
    /**
     * ServiceAccountName is the name of the ServiceAccount to run all pods of the schedule as.
     */
    serviceAccountName?: string;
    /**
     * Templates is a list of schedule templates used in a schedule
     */
    templates: Template[];
    /**
     * VolumeClaimTemplates is a list of claims that containers are allowed to reference.
     * The Schedule controller will create the claims at the beginning of the schedule and delete the claims upon completion of the schedule
     */
    volumeClaimTemplates?: kubernetes.PersistentVolumeClaim[];
    /**
     * Volumes is a list of volumes that can be mounted by containers in a schedule.
     */
...
/**
 * ScheduleStep is a reference to a template to execute in a series of step
 */
